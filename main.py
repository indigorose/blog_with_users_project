...
# User is the parent in the relationship - bidirectional one to many relationship
...
# BlogPost is the child in the relationship
class BlogPost(db.Model):
    ...
    db.create_all()
#  another child in the relationship
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and check_password_hash(user.password, password):
            ...
            flash('Invalid credentials.The email or password does not match')
            return redirect(url_for('login'))
